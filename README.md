...
<h3>NAME: MahaJanani R</h3>
<h3>REGISTER NO: 212224230147</h3>
<h3>EX. NO.4</h3>
<h3>26.05.2026</h3>
...
## PROGRAM:
```
%%writefile matrix_add1_fixed.cu
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    CHECK(cudaMallocManaged((void **)&gpuRef, nBytes));  // Fixed!
    CHECK(cudaMallocManaged((void **)&hostRef, nBytes)); // Fixed!
...
```
```
%%writefile matrix_add2_fixed.cu
#include <stdio.h>
#include <cuda_runtime.h>
#include <cuda.h>
#include <sys/time.h>
...
int main(int argc, char **argv)
{
    ...
    memset(hostRef, 0, nBytes);  // Added missing memset
    memset(gpuRef, 0, nBytes);   // Added missing memset
...
<img width="983" height="126" alt="image" src="https://github.com/user-attachments/assets/3810a1ab-6b79-449f-88e6-7cdd766b0dbe" />


<img width="898" height="123" alt="image" src="https://github.com/user-attachments/assets/4e7462d3-f64f-4882-bbc9-e93a509149eb" />
